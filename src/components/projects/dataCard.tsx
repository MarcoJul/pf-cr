...
export default function DataCard({icon, title, text, isTextWebsite, href, isMusic}: IDataCardProps) {
	...
	return (
		<li className={styles.item}>
			...
			{isMusic && 
				<iframe style={{borderRadius: "12px", border: "0px"}} src="https://open.spotify.com/embed/track/5vaOdnTldKw74qWjezLfRO?utm_source=generator&theme=0" width="100%" height="100" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
			}
		</li>
	);
}
